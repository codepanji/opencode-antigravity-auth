...
import { isEmptyResponseBody, } from "./plugin/request-helpers";
                        ...
                        while (true) {
                            ...
                            headerStyleLoop: while (!shouldSwitchAccount && currentHeaderStyleIndex < headerStyles.length) {
                                ...
                                for (let i = 0; i < ANTIGRAVITY_ENDPOINT_FALLBACKS.length; i++) {
                                    ...
                                    try {
                                        const prepared = prepareAntigravityRequest(input, init, accessToken, projectContext.effectiveProjectId, currentEndpoint, currentHeaderStyle, forceThinkingRecovery);
